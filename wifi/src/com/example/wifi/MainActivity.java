...
@SuppressLint("NewApi") public class MainActivity extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
	...
	registerReceiver(p2pStatusReceiver, filter);
    ...
    Button buttonEnable = (Button)findViewById(R.id.button1);
      ...
      public void onClick(View v) {
         ...
         */
    	  mWifiManager = (WifiManager)getSystemService(WIFI_SERVICE);
    	    if (wifiP2pManager.WIFI_P2P_STATE_ENABLED != 2 || !mWifiManager.isWifiEnabled()) {
    	              tv.setText("Wifi-Direct is not available");
    	    } else {
        ...
        new PeerListListener() {
          public void onPeersAvailable(WifiP2pDeviceList peers) {
            ...
            for (WifiP2pDevice d : deviceList) {
            	list.add("Device: " + d.deviceName + "\n" +
            			"DeviceAddress: " + d.deviceAddress + "\n" +
            			"Primary type: " + d.primaryDeviceType + "\n" +
            			"Secondary type: " + d.secondaryDeviceType + "\n" +
            			"Status: " + d.status + "\n" +
   ...
   */
  @SuppressLint("NewApi") BroadcastReceiver connectionChangedReceiver = new BroadcastReceiver() {
    @Override
    public void onReceive(Context context, Intent intent) {
